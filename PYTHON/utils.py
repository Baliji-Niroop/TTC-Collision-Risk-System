...
from config import LOG_DIR, DATA_PATH, LOGGING_CONFIG
...
def reset_system():
    ...
    WARNING: This clears logs and data!
    """
    try:
        # Clear live data
        clear_live_data()
...
def validate_environment() -> dict:
    ...
    # Check required modules (use import names, NOT pip package names)
    required_modules = [
        ("pandas", "pandas"),
        ("numpy", "numpy"),
        ("streamlit", "streamlit"),
        ("scikit-learn", "sklearn"),  # Pip package: scikit-learn, Import name: sklearn
        ("joblib", "joblib"),
        ("pyserial", "serial"),  # Pip package: pyserial, Import name: serial
    ]
...
def performance_benchmark():
    ...
    """
    import time
    from validators import validate_csv_line, detect_anomalies
