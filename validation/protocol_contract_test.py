...
def main() -> None:
    tests = {
        ...
        "wrong_field_count_extra": _expect_invalid("1000,2500.0,35.0,2.8,2.5,1,0.91,extra"),
        "legacy_alias_risk_phys": _expect_invalid("1000,2500.0,35.0,2.8,2.5,risk_phys,0.91"),
        "header_line_rejected": _expect_invalid(
            "timestamp_ms,distance_cm,speed_kmh,ttc_basic,ttc_ext,risk_class,confidence"
        ),
        "non_numeric_token_rejected": _expect_invalid("1000,2500.0,35.0,2.8,2.5,WARNING,0.91"),
    }
